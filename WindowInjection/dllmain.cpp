...
enum ZBID
{
	...
	ZBID_IMMERSIVE_INACTIVEMOBODY = 8,8,
	ZBID_IMMERSIVE_INACTIVEDOCK = 9,9,
	ZBID_IMMERSIVE.§_MOBODY = 10,10,
	ZBID_IMMERSIVE_ACTIVEDOCK = 11,11,
	ZBID_IMMERSIVE_BACKGROUND = 12,12,
	ZBID_IMMERSIVE_SEARCH = 13,13,
	ZBID_GENUINE_WINDOWS = 14,14,
	ZBID_IMMERSIVE_RESTRICTED = 15,15,
	ZBID_SYSTEM_TOOLS = 16,16,
	ZBID_LOCK = 17,17,
	ZBID_ABOVELOCK_UX = 18,18,
};
